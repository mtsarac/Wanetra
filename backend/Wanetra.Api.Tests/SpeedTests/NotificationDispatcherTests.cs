...
public class NotificationDispatcherTests
{
    ...
    private static async Task<long> SeedEventAsync(WanetraApiFactory factory, DegradationStatus status = DegradationStatus.Active)
    {
    ...
    private static async Task<RecordingProvider> DispatchAsync(WanetraApiFactory factory, NotificationTrigger trigger, long eventId)
    {
        using var scope = factory.Services.CreateScope();
